...
if ($logged_in && isset($_POST['action']) && $_POST['action'] === 'add_to_cart') {
    ...
    $restaurant = "Warung Bu Endang"; // Nama restoran ini
    ...
    $cart_item_id = 'buendang_' . $item_id;
...
<head>
    ...
    <title>Menu Warung Bu Endang - Pujasera UDS</title>
    ...
    <style>
        ...
        .toast {
            position: fixed;
            bottom: 20px; /* Diubah ke bawah agar lebih terlihat */
            right: 20px;
    ...
    <div class="container">
        ...
        <div class="restaurant-header">
            ...
            <div class="restaurant-details">
                <h1>Warung Bu Endang</h1>
                <p>Menyediakan Gado-Gado dan Soto Ayam</p>
                <div class="rating">
                    ...
                    <i class="fas fa-star"></i>
                    <i class="fas fa-star"></i>
                    <span style="color: rgba(255, 255, 255, 0.8);">(150 ulasan)</span>
                </div>
            </div>
        </div>
        ...
        <div class="menu-items">
            <div class="menu-item" data-category="Makanan">
                <div class="menu-item-image">
                    <img src="img/gadogadodo.webp" alt="Gado-gado">
                </div>
                <div class="menu-item-info">
                    <h3>Gado-gado</h3>
                    <p>Salad sayuran segar dengan saus kacang khas, lengkap dengan lontong dan kerupuk.</p>
                    ...
                    <form method="post" class="add-to-cart-form">
                        ...
                        <input type="hidden" name="item_image" value="img/gadogadodo.webp">
            ...
            <div class="menu-item" data-category="Makanan">
                <div class="menu-item-image">
                    <img src="img/sotoayamm.jpeg" alt="Soto Ayam">
                </div>
                <div class="menu-item-info">
                    <h3>Soto Ayam</h3>
                    <p>Soto ayam bening dengan suwiran ayam, soun, tauge, dan telur, disajikan dengan nasi hangat.</p>
                    <div class="menu-item-price">Rp 18.000</div>
                    <form method="post" class="add-to-cart-form">
                        <input type="hidden" name="item_id" value="2">
                        <input type="hidden" name="item_name" value="Soto Ayam">
                        <input type="hidden" name="item_price" value="18000">
                        <input type="hidden" name="item_image" value="img/sotoayamm.jpeg">
                        <div class="add-to-cart">
                            <div class="quantity">
                                <button type="button" class="quantity-btn decrease">-</button>
                                <span>1</span>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        document.querySelectorAll('.add-to-cart-form').forEach(form => {
            ...
            form.addEventListener('submit', function(e) {
                ...
                $.ajax({
                    url: 'warung-bu-endang.php', // URL AJAX menunjuk ke file ini
                    type: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
